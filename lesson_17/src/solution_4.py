...
print(sort_objects([{'a':3, 'b':7, 'c':8}, {'a':20, 'b':2, 'c':5}, {'a':9, 'b':1, 'c':2}], 'a'))
print(sort_objects([{'a':3, 'b':7, 'c':8}, {'a':20, 'b':2, 'c':5}, {'a':9, 'b':1, 'c':2}], 'b'))
print(sort_objects([{'a':3, 'b':7, 'c':8}, {'a':20, 'b':2, 'c':5}, {'a':9, 'b':1, 'c':2}], 'c'))
print(sort_objects([{'a':3, 'b':7, 'c':8}, {'a':20, 'b':2, 'c':5}, {'a':9, 'b':1, 'c':2}], 'e'))
